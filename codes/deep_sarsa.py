...
class DeepSARSA:
        ...
        for episode in range(episodes):
            ...
            for _ in range(MAX_STEPS):
                ...
                for agent_id in range(NUM_AGENTS):
                    self.update_q_network(state, actions[agent_id], rewards[agent_id], next_state, next_actions[agent_id], agent_id)
    ...
    def update_q_network(self, state, action, reward, next_state, next_action, agent_id):
        ...
        target[action] = reward + GAMMA * next_q_values[next_action]
